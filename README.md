...
- [Вопросы к SRE/DevOps на интервью](#вопросы-к-sredevops-на-интервью)
...
- [Ответы на вопросы](#ответы-на-вопросы)
  ...
  - [Контейнеры не включают ядро операционной системы — они используют ядро хоста, что делает их лёгкими и быстрыми по сравнению с виртуальными машинами.](#контейнеры-не-включают-ядро-операционной-системы--они-используют-ядро-хоста-что-делает-их-лёгкими-и-быстрыми-по-сравнению-с-виртуальными-машинами)
  ...
  - [Kubernetes](#kubernetes)
    - [Kubectl apply manifest - что происходит после этой команды (коротко)?](#kubectl-apply-manifest---что-происходит-после-этой-команды-коротко)
    - [Kubectl apply manifest - что происходит после этой команды (развернуто)?](#kubectl-apply-manifest---что-происходит-после-этой-команды-развернуто)
    ...
    - [**Основные задачи Network Policies:**](#основные-задачи-network-policies)
    - [**Как работают Network Policies?**](#как-работают-network-policies)
    - [**Особенности работы:**](#особенности-работы)
    - [**Преимущества использования Network Policies:**](#преимущества-использования-network-policies)
    - [**Ограничения Network Policies:**](#ограничения-network-policies)
  ...
  - [Общие вопросы по Kubernetes](#общие-вопросы-по-kubernetes)
    ...
    - [Восстановление etcd (disaster recovery):](#восстановление-etcd-disaster-recovery)
    - [Два слова про `REST`](#два-слова-про-rest)
  - [Linux](#linux)
  ...
  - [Общие вопросы с собесов](#общие-вопросы-с-собесов)
    - [Процессы и треды (шаринг ресурсов)](#процессы-и-треды-шаринг-ресурсов)
    - [Вопросы от Барсукова](#вопросы-от-барсукова)
    - [Шифрование](#шифрование)
  - [Базы данных](#базы-данных)
    - [Типы баз данных](#типы-баз-данных)
    - [OLTP-базы данных](#oltp-базы-данных)
    - [Примеры баз данных, используемых для OLTP:](#примеры-баз-данных-используемых-для-oltp)
    - [**Рекомендованная архитектура отказоустойчивой БД:**](#рекомендованная-архитектура-отказоустойчивой-бд)
    - [**Итоговая архитектура отказоустойчивого кластера PostgreSQL**](#итоговая-архитектура-отказоустойчивого-кластера-postgresql)
